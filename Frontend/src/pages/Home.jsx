...
const ThinkIndiaNITP='https://media.licdn.com/dms/image/C4D0BAQGRneY6b4SAmQ/company-logo_200_200/0/1677645694453?e=2147483647&v=beta&t=ZdNU1l5N-Gjoc2B9S7lNvcx9O4v06cQUyhZNFWZQZEc'
  ...
  return (
        ...
        {/****************Hero Section STARTS***************** */}
    <div className=' bg-gray-900 w-screen h-screen flex justify-between p-10 items-center'>

    
        <div className=' animate-bounce-slow' data-aos="fade-up" >
            <h1 className=' text-[#F2F2F2] text-[40px] sm:text-[70px] text-center'>Welcome To<br/><span className=' text-[#F96D00] font-semibold'>Think India</span> X NITP <br/>Student Chapter</h1>
        ...
        <div className=' sm:block hidden mr-14'>
