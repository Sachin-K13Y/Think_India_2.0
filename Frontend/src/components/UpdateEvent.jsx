...
const UpdateEventPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axiosInstance.put(`/event/updateevent/${eventId}`, formData);
    ...
    return (
        <div className="mt-[100px] bg-gray-900 py-10 px-3">
            <h1 className="text-[#F2F2F2] text-3xl font-semibold border-l-4 border-[#F96D00] px-3">Update Event</h1>
